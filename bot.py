...
class Major:
    def __init__(self):
        ...
        self.auto_play_hold_coin = base.get_config(self.config_file, "auto-play-hold-coin")
        self.auto_spin = base.get_config(self.config_file, "auto-spin")
        self.auto_play_swipe_coin = base.get_config(self.config_file, "auto-play-swipe-coin")
        self.auto_play_puzzle_durov = base.get_config(self.config_file, "auto-play-puzzle-durov")
                ...
                try:
                    ...
                    if token:
                        ...
                        if self.auto_play_swipe_coin:
                            base.log(f"{base.yellow}Auto Play Swipe Coin: {base.green}ON")
                            process_swipe_coin(token=token)
                        else:
                            base.log(f"{base.yellow}Auto Play Swipe Coin: {base.red}OFF")

                        if self.auto_play_puzzle_durov:
                            base.log(f"{base.yellow}Auto Play Puzzle Durov: {base.green}ON")
                            process_puzzle_durov(token=token, durov_file=self.durov_file)
                        else:
                            base.log(f"{base.yellow}Auto Play Puzzle Durov: {base.red}OFF")
